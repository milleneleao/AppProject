...
const fn = (order, down, originalIndex, curIndex, y) => index =>
  down && index === originalIndex
    ...
    */
      { y: curIndex * 62 + y, scale: 1.1, zIndex: '1', shadow: 15, immediate: n => n === 'y' || n === 'zIndex' }
    : { y: order.indexOf(index) * 62, scale: 1, zIndex: '0', shadow: 1, immediate: false }

function Puzzle({ items }) {
  ...
  */
  ...
  return (
    <div class="Puzzlecontent" style={{ height: items.length * 50, marginLeft: "450px", marginTop:"10px"}}>
